...
if (process.env.NODE_ENV === 'production') {
    ...
    module.exports = {
            ...
            MONGO_URI: process.env.MONGO_URI, // or hardcode if needed
            GOOGLE_CLIENT_ID: process.env.GOOGLE_CLIENT, // etc.
            ...
            PASS: "ibuhajocbbptfheu",  // hardcoded for development
            EMAIL_ID: "bzubs011@gmail.com",           // hardcoded for development
